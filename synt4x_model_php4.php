...
class Synt4x_Model extends Model
{
   ...
   * @param string $field_validations 
   * @return void
   * @author Ian Murray
   */
  ...
  /**
   * Permite llamadas a get_by_<foreign_key>
   *
   * @param string $method 
  ...
  function create($data)
  {
    ...
    elseif ($this->primary_key !== null) {
      return $this->get('*', array($this->primary_key => ($this->auto_incremental) ? $this->db->insert_id() : $data[$this->primary_key]));
    }
    else {
      return null;
    }
